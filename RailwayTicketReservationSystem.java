package com.zohoadvancedprogramming;
import java.util.ArrayList;
import java.util.Scanner;

public class RailwayTicketReservationSystem 
{
	private int totalBerths=3;//63
	private int lowerBerths = 1;//21
    private int middleBerths =1;//21
    private int upperBerths = 1;//21
    private int totalRACBerths = 1;//18
    private int totalWaitingListTickets = 1;//10
    ...
    private ArrayList<Passenger> childrenBelowFive = new ArrayList<>();
    ...
    public void bookTicket() 
    {
        ...
        if (age < 5) 
        {
            ...
            childrenBelowFive.add(new Passenger(name, age, gender, "NA")); // Store their details
            return;
        }
        if (age > 60 || (gender.equals("F") && age <= 12)) 
        {
            if (lowerBerths > 0) 
            {
                lowerBerths--;
                ...
                totalBerths--;
                System.out.println("Ticket booked successfully! (Lower Berth)");
                System.out.println("----------------------------");
                return;
            } 
            else 
    ...
    public void printBookedTickets()
    {
        ...
        else 
        {
            ...
            System.out.println("----------------------");
            System.out.println("Children Below 5 Years:");
            System.out.println("----------------------");
            for (int i = 0; i < childrenBelowFive.size(); i++)
            {
                Passenger ticket = childrenBelowFive.get(i);
                System.out.println((i + 1) + ". Name: " + ticket.name + "\n   Age: " + ticket.age +
                        "\n   Gender: " + ticket.gender + "\n   Berth Preference: " + ticket.berthPreference);
            }
            System.out.println("----------------------");
            ...
            System.out.println("Total Children Below 5: " + childrenBelowFive.size());
            System.out.println("----------------------------");
        }
    }
    ...
    public void printChildrenBelowFive() 
    {
        if (childrenBelowFive.isEmpty()) 
        {
            System.out.println("No children below 5 years.");
        } 
        else
        {
            System.out.println("Children Below 5 Years:");
    ...
    public static void main(String[] args)
    {
        ...
        while (true) 
        {
            ...
            System.out.println("5. Print Children Below 5");
            ...
            switch (choice)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    reservationSystem.printChildrenBelowFive();
                    break;
                case 6:
